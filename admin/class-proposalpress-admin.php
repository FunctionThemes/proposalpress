...
class ProposalPress_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/proposalpress-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/proposalpress-admin.js', array( 'jquery' ), $this->version, false );
	
	}
	
	/**
	 * Add plugin specific bodt class
	 * 
	 * @since	1.0.0
	 */
	...
	/**
	 * Create new Quote post content type
	 * 
	 * @since	1.0.0
	 */
	...
	/**
	 * Create new Section post content type
	 * 
	 * @since	1.0.0
	 */
	...
	/**
	 * Create new Proposal post content type
	 * 
	 * @since	1.0.0
	 */
	...
	/**
	 * Create new Quote category taxonomy
	 * 
	 * @since	1.0.0
	 */
	...
	/**
	 * Create new Proposal status taxonomy
	 * 
	 * @since	1.0.0
	 */
	...
	/**
	 * Create new Section category taxonomy
	 * 
	 * @since 1.0.0
	 */
	...
	public function custom_admin_notices( $post_states ) {
		...
		/**
		 * Proposal quote update messages
		 * 
		 * @since 1.0.0
		 */
